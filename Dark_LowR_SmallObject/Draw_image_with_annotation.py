...
# 处理后的图片 & XML 目录
image_dir = r"F:\jack_dataset\cocoalldata\Jack_generate_cat\COCO\dark\train2017Dark_resize"  # 替换为你的缩放后图像路径
xml_dir = r"F:\jack_dataset\cocoalldata\Jack_generate_cat\COCO\dark\train2017Dark_annotations_resize"  # 替换为你的修改后 XML 标注路径
...
# 随机选择一个文件进行可视化
sample_image = os.listdir(image_dir)[99]  # 选取第一个图像
